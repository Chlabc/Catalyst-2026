          ...
          <div className="relative overflow-hidden rounded-[2rem] border-2 border-primary/20 bg-primary-soft px-6 py-8 sm:px-10 sm:py-11">
            <div className="relative z-10 max-w-xl">
              <p className="text-xs font-bold uppercase tracking-[0.18em] text-primary-dark">
                Your calm, colourful corner
              </p>
              <div className="mt-3"><Greeting /></div>
              <p className="mt-4 max-w-lg text-lg leading-relaxed text-foreground/75 sm:text-xl">
                Learn the useful stuff, practise what to say, and grow a tiny
                garden that follows your cycle. No judgement. No account.
              </p>
              <div className="mt-6 flex flex-wrap gap-2 text-sm font-semibold">
                <span className="rounded-full bg-white/75 px-3 py-1.5 text-primary-dark">Learn in 2 minutes</span>
                <span className="rounded-full bg-white/75 px-3 py-1.5 text-secondary">Your data stays here</span>
              </div>
            </div>
            <div aria-hidden className="absolute -right-8 -top-12 h-48 w-48 rounded-full border-[24px] border-secondary/30" />
            <div aria-hidden className="absolute right-12 top-16 text-7xl opacity-80">🌼</div>
